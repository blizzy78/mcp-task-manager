...
type DecomposeTaskArgs = z.infer<typeof DecomposeTaskArgsSchema>
...
export async function handleDecomposeTask({ taskID, subtasks }: DecomposeTaskArgs, taskDB: TaskDB) {
